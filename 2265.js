(self["webpackChunkdemo"] = self["webpackChunkdemo"] || []).push([[2265],{
...
/* harmony import */ var _angular_cdk_bidi__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/cdk/bidi */ 71320);
...
/* harmony import */ var _angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/cdk/coercion */ 31620);
...
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/common */ 59694);
...
const _c6 = ["*"];
const VERSION = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_0__.Version('19.1.3');
...
let MatCommonModule = /*#__PURE__*/(() => {
  class MatCommonModule {
    constructor() {
      ...
      // in MatCommonModule.
      (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_cdk_a11y__WEBPACK_IMPORTED_MODULE_1__.HighContrastModeDetector)._applyBodyHighContrastModeCssClasses();
    }
...
class DateAdapter {
  ...
  locale;
  _localeChanges = /*#__PURE__*/new rxjs__WEBPACK_IMPORTED_MODULE_3__.Subject();
...
let NativeDateAdapter = /*#__PURE__*/(() => {
  class NativeDateAdapter extends DateAdapter {
    ...
    /** The injected locale. */
    _matDateLocale = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(MAT_DATE_LOCALE, {
      optional: true
    });
    constructor() {
      super();
      const matDateLocale = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(MAT_DATE_LOCALE, {
        optional: true
      });
...
function setLines(lines, element, prefix = 'mat') {
  ...
  lines.changes.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.startWith)(lines)).subscribe(({
    length
  }) => {
...
const passiveCapturingEventOptions$1 = /*#__PURE__*/(0,_angular_cdk_platform__WEBPACK_IMPORTED_MODULE_5__.normalizePassiveListenerOptions)({
  passive: true,
  capture: true
});
...
/** Options used to bind a passive capturing event. */
const passiveCapturingEventOptions = /*#__PURE__*/(0,_angular_cdk_platform__WEBPACK_IMPORTED_MODULE_5__.normalizePassiveListenerOptions)({
  passive: true,
  capture: true
});
...
let MatRipple = /*#__PURE__*/(() => {
  class MatRipple {
    ...
    constructor() {
      ...
      const globalOptions = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(MAT_RIPPLE_GLOBAL_OPTIONS, {
        optional: true
      });
...
let MatOptgroup = /*#__PURE__*/(() => {
  class MatOptgroup {
    ...
    _labelId = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_cdk_a11y__WEBPACK_IMPORTED_MODULE_1__._IdGenerator).getId('mat-optgroup-label-');
...
let MatOption = /*#__PURE__*/(() => {
  class MatOption {
    ...
    id = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_cdk_a11y__WEBPACK_IMPORTED_MODULE_1__._IdGenerator).getId('mat-option-');
    ...
    constructor() {
      (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_cdk_private__WEBPACK_IMPORTED_MODULE_7__._CdkPrivateStyleLoader).load(_StructuralStylesLoader);
      (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_cdk_private__WEBPACK_IMPORTED_MODULE_7__._CdkPrivateStyleLoader).load(_angular_cdk_private__WEBPACK_IMPORTED_MODULE_7__._VisuallyHiddenLoader);
    ...
    _handleKeydown(event) {
      if ((event.keyCode === _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_8__.ENTER || event.keyCode === _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_8__.SPACE) && !(0,_angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_8__.hasModifierKey)(event)) {
...
let MatRippleLoader = /*#__PURE__*/(() => {
  class MatRippleLoader {
    _document = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_common__WEBPACK_IMPORTED_MODULE_9__.DOCUMENT, {
      optional: true
    });
    _animationMode = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_core__WEBPACK_IMPORTED_MODULE_0__.ANIMATION_MODULE_TYPE, {
      optional: true
    });
    _globalRippleOptions = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(MAT_RIPPLE_GLOBAL_OPTIONS, {
      optional: true
    });
    _platform = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_cdk_platform__WEBPACK_IMPORTED_MODULE_5__.Platform);

...
/* harmony import */ var _angular_cdk_private__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/cdk/private */ 77824);
/* harmony import */ var _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/cdk/keycodes */ 73038);
...
/* harmony import */ var _angular_cdk_coercion_private__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/cdk/coercion/private */ 83988);
/* harmony import */ var _angular_cdk_observers__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/cdk/observers */ 32316);
/* harmony import */ var _angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/cdk/coercion */ 31620);
/* harmony import */ var _angular_cdk_layout__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/cdk/layout */ 30112);
...
let AriaDescriber = /*#__PURE__*/(() => {
  class AriaDescriber {
    ...
    _document = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_common__WEBPACK_IMPORTED_MODULE_0__.DOCUMENT);
    ...
    _id = `${nextId++}`;
    constructor() {
      (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_cdk_private__WEBPACK_IMPORTED_MODULE_3__._CdkPrivateStyleLoader).load(_angular_cdk_private__WEBPACK_IMPORTED_MODULE_3__._VisuallyHiddenLoader);
 ...
 */
class Typeahead {
  _letterKeyStream = /*#__PURE__*/new rxjs__WEBPACK_IMPORTED_MODULE_5__.Subject();
  _items = [];
  _selectedItemIndex = -1;
  /** Buffer for the letters that the user has pressed */
  _pressedLetters = [];
  _skipPredicateFn;
  _selectedItem = /*#__PURE__*/new rxjs__WEBPACK_IMPORTED_MODULE_5__.Subject();
  ...
  _setupKeyHandler(typeAheadInterval) {
    ...
    this._letterKeyStream.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.tap)(letter => this._pressedLetters.push(letter)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.debounceTime)(typeAheadInterval), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.filter)(() => this._pressedLetters.length > 0), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.map)(() => this._pressedLetters.join('').toLocaleUpperCase())).subscribe(inputString => {
...
class ListKeyManager {
  _items;
  _activeItemIndex = -1;
  _activeItem = /*#__PURE__*/(0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.signal)(null);
  _wrap = false;
  _typeaheadSubscription = rxjs__WEBPACK_IMPORTED_MODULE_5__.Subscription.EMPTY;
   ...
   */
  tabOut = /*#__PURE__*/new rxjs__WEBPACK_IMPORTED_MODULE_5__.Subject();
  /** Stream that emits whenever the active item of the list manager changes. */
  change = /*#__PURE__*/new rxjs__WEBPACK_IMPORTED_MODULE_5__.Subject();
  /**
...
class TreeKeyManager {
  ...
  constructor(items, config) {
    ...
    } else if ((0,rxjs__WEBPACK_IMPORTED_MODULE_5__.isObservable)(items)) {
  ...
  _expandCurrentItem() {
    ...
    if (!this._isCurrentItemExpanded()) {
      ...
      (0,_angular_cdk_coercion_private__WEBPACK_IMPORTED_MODULE_7__.coerceObservable)(this._activeItem.getChildren()).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.take)(1)).subscribe(children => {
  ...
  _expandAllItemsAtCurrentItemLevel() {
    ...
    if (!parent) {
      ...
      itemsToExpand = (0,_angular_cdk_coercion_private__WEBPACK_IMPORTED_MODULE_7__.coerceObservable)(parent.getChildren());
    }
...
const TREE_KEY_MANAGER = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_1__.InjectionToken('tree-key-manager', {
  providedIn: 'root',
...
let FocusTrapFactory = /*#__PURE__*/(() => {
  class FocusTrapFactory {
    _checker = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(InteractivityChecker);
...
let CdkTrapFocus = /*#__PURE__*/(() => {
  class CdkTrapFocus {
    ...
    _focusTrapFactory = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(FocusTrapFactory);
...
let ConfigurableFocusTrapFactory = /*#__PURE__*/(() => {
  class ConfigurableFocusTrapFactory {
    _checker = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(InteractivityChecker);
    _ngZone = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_core__WEBPACK_IMPORTED_MODULE_1__.NgZone);
    _focusTrapManager = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(FocusTrapManager);
    _document = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_common__WEBPACK_IMPORTED_MODULE_0__.DOCUMENT);
    _inertStrategy;
    _injector = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_core__WEBPACK_IMPORTED_MODULE_1__.Injector);
    constructor() {
      const inertStrategy = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(FOCUS_TRAP_INERT_STRATEGY, {
        optional: true
      });
 ...
 * options.
 */
const INPUT_MODALITY_DETECTOR_OPTIONS = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_1__.InjectionToken('cdk-input-modality-detector-options');
/**
...
let InputModalityDetector = /*#__PURE__*/(() => {
  class InputModalityDetector {
    ...
    _modality = new rxjs__WEBPACK_IMPORTED_MODULE_5__.BehaviorSubject(null);
    ...
    constructor() {
      ...
      const document = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_common__WEBPACK_IMPORTED_MODULE_0__.DOCUMENT);
      ...
      this.modalityChanged = this.modalityDetected.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.distinctUntilChanged)());
...
let LiveAnnouncer = /*#__PURE__*/(() => {
  class LiveAnnouncer {
    _ngZone = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_core__WEBPACK_IMPORTED_MODULE_1__.NgZone);
    _defaultOptions = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(LIVE_ANNOUNCER_DEFAULT_OPTIONS, {
      optional: true
    });
    _liveElement;
    _document = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_common__WEBPACK_IMPORTED_MODULE_0__.DOCUMENT);
    ...
    _currentResolve;
    constructor() {
      const elementToken = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(LIVE_ANNOUNCER_ELEMENT_TOKEN, {
        optional: true
      });
...
let CdkAriaLive = /*#__PURE__*/(() => {
  class CdkAriaLive {
    _elementRef = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_core__WEBPACK_IMPORTED_MODULE_1__.ElementRef);
    _liveAnnouncer = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(LiveAnnouncer);
    _contentObserver = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_cdk_observers__WEBPACK_IMPORTED_MODULE_8__.ContentObserver);
    _ngZone = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_core__WEBPACK_IMPORTED_MODULE_1__.NgZone);
...
let FocusMonitor = /*#__PURE__*/(() => {
  class FocusMonitor {
    ...
    _stopInputModalityDetector = new rxjs__WEBPACK_IMPORTED_MODULE_5__.Subject();
    constructor() {
    ...
    monitor(element, checkChildren = false) {
      const nativeElement = (0,_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_9__.coerceElement)(element);
      ...
      const info = {
        ...
        subject: new rxjs__WEBPACK_IMPORTED_MODULE_5__.Subject(),
        rootNode
      };
    ...
    _registerGlobalListeners(elementInfo) {
      ...
      if (++this._monitoredElementCount === 1) {
        ...
        this._inputModalityDetector.modalityDetected.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.takeUntil)(this._stopInputModalityDetector)).subscribe(modality => {
...
let HighContrastModeDetector = /*#__PURE__*/(() => {
  class HighContrastModeDetector {
    ...
    constructor() {
      this._breakpointSubscription = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_cdk_layout__WEBPACK_IMPORTED_MODULE_10__.BreakpointObserver).observe('(forced-colors: active)').subscribe(() => {
...
let A11yModule = /*#__PURE__*/(() => {
  class A11yModule {
    constructor() {
      (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(HighContrastModeDetector)._applyBodyHighContrastModeCssClasses();
    }
    ...
    static ɵinj = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      imports: [_angular_cdk_observers__WEBPACK_IMPORTED_MODULE_8__.ObserversModule]
    });
  }
  return A11yModule;
})();
...
let _IdGenerator = /*#__PURE__*/(() => {
  class _IdGenerator {
    _appId = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_core__WEBPACK_IMPORTED_MODULE_1__.APP_ID);
    /**

(self["webpackChunkdemo"] = self["webpackChunkdemo"] || []).push([[4189],{
...
/* harmony import */ var _chunk_BFAMUDN2_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chunk-BFAMUDN2.mjs */ 86482);
/* harmony import */ var _chunk_SKB7J2MH_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chunk-SKB7J2MH.mjs */ 41391);
/* harmony import */ var _chunk_27ZLIBVY_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./chunk-27ZLIBVY.mjs */ 30330);
...
var ClassMember = class {
  static #_ = (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(this, "ClassMember");
  constructor(input, memberType) {
    this.memberType = memberType;
    this.visibility = "";
    this.classifier = "";
    this.text = "";
    const sanitizedInput = (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.sanitizeText)(input, (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.getConfig2)());
    this.parseMember(sanitizedInput);
  }
  getDisplayDetails() {
    let displayText = this.visibility + (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.parseGenericTypes)(this.id);
    if (this.memberType === "method") {
      displayText += `(${(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.parseGenericTypes)(this.parameters.trim())})`;
      if (this.returnType) {
        displayText += " : " + (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.parseGenericTypes)(this.returnType);
      }
    }
  ...
  parseMember(input) {
    ...
    const combinedText = `${this.visibility ? "\\" + this.visibility : ""}${(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.parseGenericTypes)(this.id)}${this.memberType === "method" ? `(${(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.parseGenericTypes)(this.parameters)})${this.returnType ? " : " + (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.parseGenericTypes)(this.returnType) : ""}` : ""}`;
...
var classCounter = 0;
var sanitizeText2 = /* @__PURE__ */(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(txt => _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.common_default.sanitizeText(txt, (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.getConfig2)()), "sanitizeText");
var ClassDB = class {
  constructor() {
    this.relations = [];
    ...
    this.setupToolTips = /* @__PURE__ */(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(element => {
    ...
    this.direction = "TB";
    this.setAccTitle = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.setAccTitle;
    this.getAccTitle = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.getAccTitle;
    this.setAccDescription = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.setAccDescription;
    this.getAccDescription = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.getAccDescription;
    this.setDiagramTitle = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.setDiagramTitle;
    this.getDiagramTitle = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.getDiagramTitle;
    this.getConfig = /* @__PURE__ */(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(() => (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.getConfig2)().class, "getConfig");
  ...
  static #_ = (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(this, "ClassDB");
  splitClassNameAndType(_id) {
    const id = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.common_default.sanitizeText(_id, (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.getConfig2)());
    let genericType = "";
    let className = id;
    if (id.indexOf("~") > 0) {
  ...
  addClass(_id) {
    ...
    const name = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.common_default.sanitizeText(className, (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.getConfig2)());
  ...
  addRelation(classRelation) {
    _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.log.debug("Adding relation: " + JSON.stringify(classRelation));
    ...
    classRelation.relationTitle1 = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.common_default.sanitizeText(classRelation.relationTitle1.trim(), (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.getConfig2)());
    classRelation.relationTitle2 = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.common_default.sanitizeText(classRelation.relationTitle2.trim(), (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.getConfig2)());
  ...
  setLink(ids, linkStr, target) {
    const config = (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.getConfig2)();
    ids.split(",").forEach(_id => {
      let id = _id;
      if (/\d/.exec(_id[0])) {
        id = MERMAID_DOM_ID_PREFIX + id;
      ...
      if (theClass) {
        theClass.link = _chunk_55PJQP7W_mjs__WEBPACK_IMPORTED_MODULE_5__.utils_default.formatUrl(linkStr, config);
  ...
  setClickFunc(_domId, functionName, functionArgs) {
    const domId = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.common_default.sanitizeText(_domId, (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.getConfig2)());
    const config = (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.getConfig2)();
      ...
      this.functions.push(() => {
        ...
        if (elem !== null) {
          elem.addEventListener("click", () => {
            _chunk_55PJQP7W_mjs__WEBPACK_IMPORTED_MODULE_5__.utils_default.runFunc(functionName, ...argList);
          }, false);
        }
      });
    }
  ...
  getData() {
    ...
    for (const classRelation of this.relations) {
      cnt++;
      const edge = {
        id: (0,_chunk_55PJQP7W_mjs__WEBPACK_IMPORTED_MODULE_5__.getEdgeId)(classRelation.id1, classRelation.id2, {
          prefix: "id",
          counter: cnt
        }),
...
var getStyles = /* @__PURE__ */(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(options => `g.classGroup text {
...
var getDir = /* @__PURE__ */(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)((parsedItem, defaultDir = "TB") => {
  if (!parsedItem.doc) {
    return defaultDir;
  }
  let dir = defaultDir;
...
var getClasses = /* @__PURE__ */(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(function (text, diagramObj) {
...
var draw = /* @__PURE__ */(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(/*#__PURE__*/function () {
  var _ref = (0,_Users_ba5ik7_Documents_GIT_tmdjr_ngx_editor_js2_blocks_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (text, id, _version, diag) {
    _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.log.info("REF0:");
    _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.log.info("Drawing class diagram (v3)", id);
    const {
      securityLevel,
      state: conf,
      layout
    } = (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_6__.getConfig2)();
    ...
    yield (0,_chunk_27ZLIBVY_mjs__WEBPACK_IMPORTED_MODULE_4__.render)(data4Layout, svg);
    const padding = 8;
    _chunk_55PJQP7W_mjs__WEBPACK_IMPORTED_MODULE_5__.utils_default.insertTitle(svg, "classDiagramTitleText", conf?.titleTopMargin ?? 25, diag.db.getDiagramTitle());
    (0,_chunk_SKB7J2MH_mjs__WEBPACK_IMPORTED_MODULE_3__.setupViewPortForSVG)(svg, padding, "classDiagram", conf?.useMaxWidth ?? true);
  });
...
/* harmony export */ });
/* harmony import */ var _chunk_QEP2MXWD_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chunk-QEP2MXWD.mjs */ 62073);
/* harmony import */ var _chunk_E2GYISFI_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chunk-E2GYISFI.mjs */ 86241);
/* harmony import */ var _chunk_BFAMUDN2_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chunk-BFAMUDN2.mjs */ 86482);
/* harmony import */ var _chunk_SKB7J2MH_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chunk-SKB7J2MH.mjs */ 41391);
/* harmony import */ var _chunk_27ZLIBVY_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./chunk-27ZLIBVY.mjs */ 30330);
/* harmony import */ var _chunk_CPHRQXFT_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./chunk-CPHRQXFT.mjs */ 63529);
/* harmony import */ var _chunk_MXNHSMXR_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./chunk-MXNHSMXR.mjs */ 85976);
/* harmony import */ var _chunk_Y3GBUOFX_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./chunk-Y3GBUOFX.mjs */ 85906);
/* harmony import */ var _chunk_AC5SNWB5_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./chunk-AC5SNWB5.mjs */ 88353);
/* harmony import */ var _chunk_UWXLY5YG_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./chunk-UWXLY5YG.mjs */ 83217);
/* harmony import */ var _chunk_QESNASVV_mjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./chunk-QESNASVV.mjs */ 99810);
/* harmony import */ var _chunk_55PJQP7W_mjs__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./chunk-55PJQP7W.mjs */ 18778);
/* harmony import */ var _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./chunk-3XYRH5AP.mjs */ 48177);

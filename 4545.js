...
/* harmony import */ var _chunk_55IACEB6_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chunk-55IACEB6.mjs */ 5675);
/* harmony import */ var _chunk_QN33PNHL_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./chunk-QN33PNHL.mjs */ 8086);
/* harmony import */ var _chunk_N4CR4FBY_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./chunk-N4CR4FBY.mjs */ 72271);
/* harmony import */ var _chunk_QXUST7PY_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./chunk-QXUST7PY.mjs */ 98954);
/* harmony import */ var _chunk_HN2XXSSU_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./chunk-HN2XXSSU.mjs */ 36384);
/* harmony import */ var _chunk_JZLCHNYA_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./chunk-JZLCHNYA.mjs */ 87452);
/* harmony import */ var _chunk_CVBHYZKI_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./chunk-CVBHYZKI.mjs */ 32239);
/* harmony import */ var _chunk_ATLVNIR6_mjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./chunk-ATLVNIR6.mjs */ 19753);
/* harmony import */ var _chunk_JA3XYJ7Z_mjs__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./chunk-JA3XYJ7Z.mjs */ 59355);
/* harmony import */ var _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./chunk-S3R3BYOJ.mjs */ 52052);
/* harmony import */ var _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./chunk-ABZYJK2D.mjs */ 79006);
/* harmony import */ var _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./chunk-AGHRB4JF.mjs */ 32303);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! d3 */ 40622);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! khroma */ 85404);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! khroma */ 61187);
...
var FlowDB = class {
  ...
  constructor() {
    ...
    this.config = (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_13__.getConfig2)();
    ...
    this.funs = [];
    this.setAccTitle = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_13__.setAccTitle;
    this.setAccDescription = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_13__.setAccDescription;
    this.setDiagramTitle = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_13__.setDiagramTitle;
    this.getAccTitle = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_13__.getAccTitle;
    this.getAccDescription = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_13__.getAccDescription;
    this.getDiagramTitle = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_13__.getDiagramTitle;
  ...
  sanitizeText(txt) {
    return _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_13__.common_default.sanitizeText(txt, this.config);
  }
  /**
  ...
  addVertex(id, textObj, type, style, classes, dir, props = {}, metadata) {
    ...
    if (doc !== void 0) {
      if (doc.shape) {
        ...
        } else if (!(0,_chunk_JZLCHNYA_mjs__WEBPACK_IMPORTED_MODULE_8__.isValidShape)(doc.shape)) {
  ...
  addSingleLink(_start, _end, type, id) {
    ...
    if (id && !this.edges.some(e => e.id === id)) {
      ...
      if (existingLinks.length === 0) {
        edge.id = (0,_chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_12__.getEdgeId)(edge.start, edge.end, {
          counter: 0,
          prefix: "L"
        });
      } else {
...
You have to call mermaid.initialize.`);
  ...
  setClickFun(id, functionName, functionArgs) {
    ...
    if ((0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_13__.getConfig2)().securityLevel !== "loose") {
      return;
    }
      ...
      this.funs.push(() => {
        ...
        if (elem !== null) {
          elem.addEventListener("click", () => {
            _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_12__.utils_default.runFunc(functionName, ...argList);
          }, false);
        }
      });
    }
  ...
  setLink(ids, linkStr, target) {
    ids.split(",").forEach(id => {
      const vertex = this.vertices.get(id);
      if (vertex !== void 0) {
        vertex.link = _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_12__.utils_default.formatUrl(linkStr, this.config);
  ...
  setupToolTips(element) {
    let tooltipElem = (0,d3__WEBPACK_IMPORTED_MODULE_15__.select)(".mermaidTooltip");
    if ((tooltipElem._groups || tooltipElem)[0][0] === null) {
      tooltipElem = (0,d3__WEBPACK_IMPORTED_MODULE_15__.select)("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0);
    }
  ...
  clear(ver = "gen-2") {
    ...
    this.version = ver;
    this.config = (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_13__.getConfig2)();
    (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_13__.clear)();
  }
  setGen(ver) {
  ...
  addSubGraph(_id, list, _title) {
    ...
    let dir = result.dir;
    const flowchartConfig = (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_13__.getConfig2)().flowchart ?? {};
    dir = dir ?? (flowchartConfig.inheritDir ? this.getDirection() ?? (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_13__.getConfig2)().direction ?? void 0 : void 0);
  ...
  getData() {
    const config = (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_13__.getConfig2)();
    const nodes = [];
    const edges = [];
    ...
    e.forEach((rawEdge, index) => {
      ...
      const edge = {
        id: (0,_chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_12__.getEdgeId)(rawEdge.start, rawEdge.end, {
          counter: index,
          prefix: "L"
        }, rawEdge.id),
  ...
  defaultConfig() {
    return _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_13__.defaultConfig2.flowchart;
  }
};
...
var draw = /* @__PURE__ */(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_14__.__name)(/*#__PURE__*/function () {
  var _ref = (0,_Users_ba5ik7_Documents_GIT_tmdjr_ngx_editor_js2_blocks_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (text, id, _version, diag) {
    ...
    const {
      ...
      flowchart: conf,
      layout
    } = (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_13__.getConfig2)();
    let sandboxElement;
    if (securityLevel === "sandbox") {
    ...
    data4Layout.layoutAlgorithm = (0,_chunk_N4CR4FBY_mjs__WEBPACK_IMPORTED_MODULE_5__.getRegisteredLayoutAlgorithm)(layout);
    if (data4Layout.layoutAlgorithm === "dagre" && layout === "elk") {
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_14__.log.warn("flowchart-elk was moved to an external package in Mermaid v11. Please refer [release notes](https://github.com/mermaid-js/mermaid/releases/tag/v11.0.0) for more details. This diagram will be rendered using `dagre` layout as a fallback.");
    }
    ...
    yield (0,_chunk_N4CR4FBY_mjs__WEBPACK_IMPORTED_MODULE_5__.render)(data4Layout, svg);
    const padding = data4Layout.config.flowchart?.diagramPadding ?? 8;
    _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_12__.utils_default.insertTitle(svg, "flowchartTitleText", conf?.titleTopMargin || 0, diag.db.getDiagramTitle());
    (0,_chunk_QN33PNHL_mjs__WEBPACK_IMPORTED_MODULE_4__.setupViewPortForSVG)(svg, padding, "flowchart", conf?.useMaxWidth || false);
...
var parser = function () {
  ...
  var parser2 = {
    trace: /* @__PURE__ */(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_14__.__name)(function trace() {}, "trace"),
    yy: {},
    symbols_: {
      "error": 2,
      "start": 3,
...
var fade = /* @__PURE__ */(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_14__.__name)((color, opacity) => {
  const channel2 = khroma__WEBPACK_IMPORTED_MODULE_17__["default"];
...
var diagram = {
  ...
  init: /* @__PURE__ */(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_14__.__name)(cnf => {
    ...
    if (cnf.layout) {
      (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_13__.setConfig2)({
        layout: cnf.layout
      });
    }

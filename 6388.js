(self["webpackChunkdemo"] = self["webpackChunkdemo"] || []).push([[6388],{
...
/* harmony export */ });
/* harmony import */ var d3_array__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! d3-array */ 19929);
/* harmony import */ var d3_array__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! d3-array */ 89440);
/* harmony import */ var d3_array__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! d3-array */ 31614);
/* harmony import */ var _align_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./align.js */ 74046);
/* harmony import */ var _constant_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./constant.js */ 13827);
...
/* harmony import */ var d3_sankey__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! d3-sankey */ 56099);
...
var parser = function () {
  var o = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_0__.__name)(function (k, v, o2, l) {
    ...
    $V2 = [1, 5, 10, 12];
  var parser2 = {
    trace: /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_0__.__name)(function trace() {}, "trace"),
    yy: {},
    symbols_: {
      "error": 2,
      "start": 3,
...
var clear2 = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_0__.__name)(() => {
  links = [];
  nodes = [];
...
var SankeyLink = class {
  ...
  static #_ = (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_0__.__name)(this, "SankeyLink");
};
var addLink = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_0__.__name)((source, target, value) => {
...
var SankeyNode = class {
  ...
  static #_ = (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_0__.__name)(this, "SankeyNode");
};
var findOrCreateNode = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_0__.__name)(ID => {
  ID = _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_0__.common_default.sanitizeText(ID, (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_0__.getConfig2)());
...
var getNodes = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_0__.__name)(() => nodes, "getNodes");
var getLinks = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_0__.__name)(() => links, "getLinks");
var getGraph = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_0__.__name)(() => ({
...
var sankeyDB_default = {
  nodesMap,
  getConfig: /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_0__.__name)(() => (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_0__.getConfig2)().sankey, "getConfig"),
  getNodes,
  getLinks,
  getGraph,
  addLink,
...
var Uid = /*#__PURE__*/(() => {
  let Uid = class _Uid {
    static #_ = (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_0__.__name)(this, "Uid");
...
var draw = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_0__.__name)(function (text, id, _version, diagObj) {
  const {
    securityLevel,
    sankey: conf
  } = (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_0__.getConfig2)();
  const defaultSankeyConfig = _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_0__.defaultConfig2.sankey;
  let sandboxElement;
  ...
  const nodeWidth = 10;
  const sankey = (0,d3_sankey__WEBPACK_IMPORTED_MODULE_2__.sankey)().nodeId(d => d.id).nodeWidth(nodeWidth).nodePadding(10 + (showValues ? 15 : 0)).nodeAlign(nodeAlign).extent([[0, 0], [width, height]]);
  sankey(graph);
  ...
  const getText = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_0__.__name)(({
    id: id2,
    value
  }) => {
    if (!showValues) {
...
${prefix}${Math.round(value * 100) / 100}${suffix}`;
  ...
  switch (linkColor) {
    case "gradient":
      coloring = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_0__.__name)(d => d.uid, "coloring");
      break;
    case "source":
      coloring = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_0__.__name)(d => colorScheme(d.source.id), "coloring");
      break;
    case "target":
      coloring = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_0__.__name)(d => colorScheme(d.target.id), "coloring");
      break;
    default:
      coloring = linkColor;
  }
  ...
  (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_0__.setupGraphViewbox)(void 0, svg, 0, useMaxWidth);
}, "draw");
...
var prepareTextForParsing = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_0__.__name)(text => {
  const textToParse = text.replaceAll(/^[^\S\n\r]+|[^\S\n\r]+$/g, "").replaceAll(/([\n\r])+/g, "\n").trim();
  return textToParse;
}, "prepareTextForParsing");

// src/diagrams/sankey/styles.js
var getStyles = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_0__.__name)(options => `.label {
...
/* harmony export */   "default": () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var d3_shape__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! d3-shape */ 70455);

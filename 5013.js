(self["webpackChunkdemo"] = self["webpackChunkdemo"] || []).push([[5013],{
...
var ClassMember = class {
  ...
  constructor(input, memberType) {
    ...
    this.classifier = "";
    this.text = "";
    const sanitizedInput = (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.sanitizeText)(input, (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.getConfig2)());
    this.parseMember(sanitizedInput);
  }
  getDisplayDetails() {
    let displayText = this.visibility + (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.parseGenericTypes)(this.id);
    if (this.memberType === "method") {
      displayText += `(${(0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.parseGenericTypes)(this.parameters.trim())})`;
      if (this.returnType) {
        displayText += " : " + (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.parseGenericTypes)(this.returnType);
      }
    }
  ...
  parseMember(input) {
    ...
    const combinedText = `${this.visibility ? "\\" + this.visibility : ""}${(0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.parseGenericTypes)(this.id)}${this.memberType === "method" ? `(${(0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.parseGenericTypes)(this.parameters)})${this.returnType ? " : " + (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.parseGenericTypes)(this.returnType) : ""}` : ""}`;
...
var classCounter = 0;
var sanitizeText2 = /* @__PURE__ */(0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(txt => _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.sanitizeText(txt, (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.getConfig2)()), "sanitizeText");
var ClassDB = class {
  constructor() {
    this.relations = [];
    ...
    this.setupToolTips = /* @__PURE__ */(0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(element => {
    ...
    this.getConfig = /* @__PURE__ */(0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(() => (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.getConfig2)().class, "getConfig");
  ...
  addClass(_id) {
    ...
    const name = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.sanitizeText(className, (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.getConfig2)());
  ...
  addRelation(classRelation) {
    _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.log.debug("Adding relation: " + JSON.stringify(classRelation));
    ...
    classRelation.relationTitle1 = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.sanitizeText(classRelation.relationTitle1.trim(), (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.getConfig2)());
    classRelation.relationTitle2 = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.sanitizeText(classRelation.relationTitle2.trim(), (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.getConfig2)());
  ...
  setLink(ids, linkStr, target) {
    ...
    ids.split(",").forEach(_id => {
      ...
      if (theClass) {
        theClass.link = _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_3__.utils_default.formatUrl(linkStr, config);
  ...
  setClickFunc(_domId, functionName, functionArgs) {
    const domId = _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.common_default.sanitizeText(_domId, (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.getConfig2)());
    const config = (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.getConfig2)();
      ...
      this.functions.push(() => {
        ...
        if (elem !== null) {
          elem.addEventListener("click", () => {
            _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_3__.utils_default.runFunc(functionName, ...argList);
          }, false);
        }
      });
    }
  ...
  getData() {
    ...
    for (const classRelation of this.relations) {
      cnt++;
      const edge = {
        id: (0,_chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_3__.getEdgeId)(classRelation.id1, classRelation.id2, {
          prefix: "id",
          counter: cnt
        }),
...
var getStyles = /* @__PURE__ */(0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(options => `g.classGroup text {
...
var getDir = /* @__PURE__ */(0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)((parsedItem, defaultDir = "TB") => {
  if (!parsedItem.doc) {
    return defaultDir;
  }
  let dir = defaultDir;
...
var draw = /* @__PURE__ */(0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(/*#__PURE__*/function () {
  var _ref = (0,_Users_ba5ik7_Documents_GIT_tmdjr_ngx_editor_js2_blocks_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (text, id, _version, diag) {
    ...
    _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__.log.info("Drawing class diagram (v3)", id);
    const {
      securityLevel,
      state: conf,
      layout
    ...
    const padding = 8;
    _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_3__.utils_default.insertTitle(svg, "classDiagramTitleText", conf?.titleTopMargin ?? 25, diag.db.getDiagramTitle());
    (0,_chunk_RZ5BOZE2_mjs__WEBPACK_IMPORTED_MODULE_1__.setupViewPortForSVG)(svg, padding, "classDiagram", conf?.useMaxWidth ?? true);
  });

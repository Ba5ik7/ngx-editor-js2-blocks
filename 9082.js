...
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! khroma */ 61187);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! khroma */ 85404);
...
var parser = function () {
  var o = /* @__PURE__ */(0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__.__name)(function (k, v, o2, l) {
    ...
    $VH = [19, 56, 58, 60];
  var parser2 = {
    trace: /* @__PURE__ */(0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__.__name)(function trace() {}, "trace"),
    yy: {},
    symbols_: {
      "error": 2,
      "start": 3,
...
var ErDB = class {
  constructor() {
    ...
    this.getConfig = /* @__PURE__ */(0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__.__name)(() => (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__.getConfig2)().er, "getConfig");
    this.clear();
  ...
  addEntity(name, alias = "") {
    if (!this.entities.has(name)) {
      this.entities.set(name, {
        ...
        alias,
        shape: "erBox",
        look: (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__.getConfig2)().look ?? "default",
        cssClasses: "default",
        cssStyles: []
      });
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__.log.info("Added new entity :", name);
    } else if (!this.entities.get(name)?.alias && alias) {
      this.entities.get(name).alias = alias;
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__.log.info(`Add alias '${alias}' to entity '${name}'`);
    }
  ...
  addAttributes(entityName, attribs) {
    ...
    for (i = attribs.length - 1; i >= 0; i--) {
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__.log.debug("Added attribute ", attribs[i].name);
    }
  }
  /**
   * Add a relationship
  ...
  addRelationship(entA, rolA, entB, rSpec) {
    ...
    _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__.log.debug("Added new relationship :", rel);
  }
  getRelationships() {
  ...
  getData() {
    ...
    for (const relationship of this.relationships) {
      const edge = {
        id: (0,_chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_9__.getEdgeId)(relationship.entityA, relationship.entityB, {
          prefix: "id",
          counter: count++
        }),
        type: "normal",
...
(0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__.__export)(erRenderer_unified_exports, {
  draw: () => draw
});

var draw = /* @__PURE__ */(0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__.__name)(/*#__PURE__*/function () {
  var _ref = (0,_Users_ba5ik7_Documents_GIT_tmdjr_ngx_editor_js2_blocks_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (text, id, _version, diag) {
    ...
    _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__.log.info("Drawing er diagram (unified)", id);
    const {
      securityLevel,
      er: conf,
      layout
    } = (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__.getConfig2)();
    ...
    const padding = 8;
    _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_9__.utils_default.insertTitle(svg, "erDiagramTitleText", conf?.titleTopMargin ?? 25, diag.db.getDiagramTitle());
    (0,_chunk_RZ5BOZE2_mjs__WEBPACK_IMPORTED_MODULE_1__.setupViewPortForSVG)(svg, padding, "erDiagram", conf?.useMaxWidth ?? true);
  });
...
var getStyles = /* @__PURE__ */(0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__.__name)(options => `
  .entityBox {

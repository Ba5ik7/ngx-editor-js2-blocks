...
var RequirementDB = class {
  constructor() {
    ...
    this.getConfig = /* @__PURE__ */(0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__.__name)(() => (0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__.getConfig2)().requirement, "getConfig");
    this.clear();
  ...
  addElement(name) {
    if (!this.elements.has(name)) {
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__.log.info("Added new element: ", name);
    }
...
(0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__.__export)(requirementRenderer_exports, {
  draw: () => draw
});
var draw = /* @__PURE__ */(0,_chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__.__name)(/*#__PURE__*/function () {
  var _ref = (0,_Users_ba5ik7_Documents_GIT_tmdjr_ngx_editor_js2_blocks_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (text, id, _version, diag) {
    ...
    _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__.log.info("Drawing requirement diagram (unified)", id);
    const {
      securityLevel,
      state: conf,
      layout
    ...
    const padding = 8;
    _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_9__.utils_default.insertTitle(svg, "requirementDiagramTitleText", conf?.titleTopMargin ?? 25, diag.db.getDiagramTitle());
    (0,_chunk_RZ5BOZE2_mjs__WEBPACK_IMPORTED_MODULE_1__.setupViewPortForSVG)(svg, padding, "requirementDiagram", conf?.useMaxWidth ?? true);
  });

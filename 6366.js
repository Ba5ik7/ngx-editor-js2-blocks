...
/* harmony import */ var _directionality_CChdj3az_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./directionality-CChdj3az.mjs */ 32373);
/* harmony import */ var _id_generator_LuoRZSid_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./id-generator-LuoRZSid.mjs */ 51590);
/* harmony import */ var _focus_key_manager_CPmlyB_c_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./focus-key-manager-CPmlyB_c.mjs */ 49390);
/* harmony import */ var _keycodes_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./keycodes.mjs */ 74879);
/* harmony import */ var _keycodes_CpHkExLC_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./keycodes-CpHkExLC.mjs */ 5758);
/* harmony import */ var _shadow_dom_B0oHn41l_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./shadow-dom-B0oHn41l.mjs */ 66488);
...
let CdkStep = /*#__PURE__*/(() => {
  class CdkStep {
    ...
    _interacted = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.signal)(false);
    ...
    _state = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.signal)(undefined);
    ...
    _editable = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.signal)(true);
    ...
    _completedOverride = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.signal)(null);
    /** Current index of the step within the stepper. */
    index = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.signal)(-1);
    /** Whether the step is selected. */
    isSelected = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.computed)(() => this._stepper.selectedIndex === this.index());
    ...
    _customError = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.signal)(null);
    _getDefaultError() {
    ...
    static ɵcmp = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      contentQueries: function CdkStep_ContentQueries(rf, ctx, dirIndex) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵcontentQuery"](dirIndex,
          // Note: we look for `ControlContainer` here, because both `NgForm` and `FormGroupDirective`
          // provides themselves as such, but we don't want to have a concrete reference to both of
          // the directives. The type is marked as `Partial` in case we run into a class that provides
          // itself as `ControlContainer` but doesn't have the same interface as the directives.
          _angular_forms__WEBPACK_IMPORTED_MODULE_1__.ControlContainer, 5);
        }
        if (rf & 2) {
          let _t;
...
let CdkStepper = /*#__PURE__*/(() => {
  class CdkStepper {
    _dir = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_directionality_CChdj3az_mjs__WEBPACK_IMPORTED_MODULE_4__.D, {
      optional: true
    });
    ...
    _selectedIndex = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.signal)(0);
    ...
    _groupId = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_id_generator_LuoRZSid_mjs__WEBPACK_IMPORTED_MODULE_5__._).getId('cdk-stepper-');
    ...
    ngAfterViewInit() {
      ...
      this._keyManager = new _focus_key_manager_CPmlyB_c_mjs__WEBPACK_IMPORTED_MODULE_6__.F(this._sortedHeaders).withWrap().withHomeAndEnd().withVerticalOrientation(this._orientation === 'vertical');
    ...
    _onKeydown(event) {
      ...
      if (manager?.activeItemIndex != null && !hasModifier && (keyCode === _keycodes_CpHkExLC_mjs__WEBPACK_IMPORTED_MODULE_8__.S || keyCode === _keycodes_CpHkExLC_mjs__WEBPACK_IMPORTED_MODULE_8__.c)) {
    ...
    _containsFocus() {
      ...
      const focusedElement = (0,_shadow_dom_B0oHn41l_mjs__WEBPACK_IMPORTED_MODULE_9__.c)();

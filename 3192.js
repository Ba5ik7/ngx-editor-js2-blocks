(self["webpackChunkdemo"] = self["webpackChunkdemo"] || []).push([[3192],{
...
/* harmony import */ var _chunk_55IACEB6_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chunk-55IACEB6.mjs */ 5675);
/* harmony import */ var _chunk_QN33PNHL_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chunk-QN33PNHL.mjs */ 8086);
/* harmony import */ var _chunk_N4CR4FBY_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chunk-N4CR4FBY.mjs */ 72271);
/* harmony import */ var _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./chunk-S3R3BYOJ.mjs */ 52052);
/* harmony import */ var _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./chunk-ABZYJK2D.mjs */ 79006);
/* harmony import */ var _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./chunk-AGHRB4JF.mjs */ 32303);
...
var parser = function () {
  var o = /* @__PURE__ */(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(function (k, v, o2, l) {
    ...
    $Vq = [1, 38],
    $Vr = [1, 34],
    $Vs = [1, 4, 5, 16, 17, 19, 21, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 41, 45, 48, 51, 52, 53, 54, 57],
    $Vt = [1, 4, 5, 14, 15, 16, 17, 19, 21, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 39, 40, 41, 45, 48, 51, 52, 53, 54, 57],
    $Vu = [4, 5, 16, 17, 19, 21, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 41, 45, 48, 51, 52, 53, 54, 57];
  var parser2 = {
...
var getDir = /* @__PURE__ */(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)((parsedItem, defaultDir = DEFAULT_NESTED_DOC_DIR) => {
  if (!parsedItem.doc) {
    return defaultDir;
  }
  let dir = defaultDir;
...
var draw = /* @__PURE__ */(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(/*#__PURE__*/function () {
  var _ref = (0,_Users_ba5ik7_Documents_GIT_tmdjr_ngx_editor_js2_blocks_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (text, id, _version, diag) {
    _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.log.info("REF0:");
    _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.log.info("Drawing state diagram (v2)", id);
    const {
      securityLevel,
      state: conf,
      layout
    ...
    yield (0,_chunk_N4CR4FBY_mjs__WEBPACK_IMPORTED_MODULE_3__.render)(data4Layout, svg);
    const padding = 8;
    try {
      ...
      links.forEach((linkInfo, key) => {
        ...
        if (!stateId) {
          _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.log.warn("\u26A0\uFE0F Invalid or missing stateId from key:", JSON.stringify(key));
          return;
        }
        ...
        if (!matchedElem) {
          _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.log.warn("\u26A0\uFE0F Could not find node matching text:", stateId);
          return;
        }
        const parent = matchedElem.parentNode;
        if (!parent) {
          _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.log.warn("\u26A0\uFE0F Node has no parent, cannot wrap:", stateId);
          return;
        }
        ...
        _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.log.info("\u{1F517} Wrapped node in <a> tag for:", stateId, linkInfo.url);
      });
    } catch (err) {
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.log.error("\u274C Error injecting clickable links:", err);
    }
    _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_4__.utils_default.insertTitle(svg, "statediagramTitleText", conf?.titleTopMargin ?? 25, diag.db.getDiagramTitle());
    (0,_chunk_QN33PNHL_mjs__WEBPACK_IMPORTED_MODULE_2__.setupViewPortForSVG)(svg, padding, CSS_DIAGRAM, conf?.useMaxWidth ?? true);
  });
...
(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(stateDomId, "stateDomId");
var setupDoc = /* @__PURE__ */(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)((parentParsedItem, doc, diagramStates, nodes, edges, altFlag, look, classes) => {
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.log.trace("items", doc);
  doc.forEach(item => {
    switch (item.stmt) {
      case STMT_STATE:
      ...
      case STMT_RELATION:
        {
          ...
          const edgeData = {
            ...
            style: G_EDGE_STYLE,
            labelStyle: "",
            label: _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__.common_default.sanitizeText(item.description ?? "", (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)()),
...
var getDir2 = /* @__PURE__ */(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)((parsedItem, defaultDir = DEFAULT_NESTED_DOC_DIR) => {
  let dir = defaultDir;
  if (parsedItem.doc) {
    for (const parsedItemDoc of parsedItem.doc) {
      if (parsedItemDoc.stmt === "dir") {
...
(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(insertOrUpdateNode, "insertOrUpdateNode");
function getClassesFromDbInfo(dbInfoItem) {
  return dbInfoItem?.classes?.join(" ") ?? "";
}
(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(getClassesFromDbInfo, "getClassesFromDbInfo");
function getStylesFromDbInfo(dbInfoItem) {
  return dbInfoItem?.styles ?? [];
}
(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(getStylesFromDbInfo, "getStylesFromDbInfo");
var dataFetcher = /* @__PURE__ */(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)((parent, parsedItem, diagramStates, nodes, edges, altFlag, look, classes) => {
  const itemId = parsedItem.id;
  const dbState = diagramStates.get(itemId);
  const classStr = getClassesFromDbInfo(dbState);
  const style = getStylesFromDbInfo(dbState);
  const config = (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)();
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.log.info("dataFetcher parsedItem", parsedItem, dbState, style);
  if (itemId !== "root") {
    ...
    if (!nodeDb.get(itemId)) {
      nodeDb.set(itemId, {
        id: itemId,
        shape,
        description: _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__.common_default.sanitizeText(itemId, config),
    ...
    if (parsedItem.description) {
      ...
      newNode.description = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__.common_default.sanitizeTextOrArray(newNode.description, config);
    }
    ...
    if (!newNode.type && parsedItem.doc) {
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.log.info("Setting cluster for XCX", itemId, getDir2(parsedItem));
      newNode.type = "group";
    ...
    if (parent && parent.id !== "root") {
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.log.trace("Setting node ", itemId, " to be child of its parent ", parent.id);
  ...
  if (parsedItem.doc) {
    _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.log.trace("Adding nodes children ");
    setupDoc(parsedItem, parsedItem.doc, diagramStates, nodes, edges, !altFlag, look, classes);
  }
}, "dataFetcher");
var reset = /* @__PURE__ */(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(() => {
  nodeDb.clear();
  graphItemCount = 0;
}, "reset");
...
var newClassesList = /* @__PURE__ */(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(() => /* @__PURE__ */new Map(), "newClassesList");
var newDoc = /* @__PURE__ */(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(() => ({
  relations: [],
  states: /* @__PURE__ */new Map(),
  documents: {}
}), "newDoc");
var clone = /* @__PURE__ */(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(o => JSON.parse(JSON.stringify(o)), "clone");
var StateDB = /*#__PURE__*/(() => {
  let StateDB = class {
    constructor(version) {
    ...
    static {
      (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(this, "StateDB");
    }
    static {
      this.relationType = {
        AGGREGATION: 0,
    ...
    setRootDoc(o) {
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.log.info("Setting root doc", o);
      this.rootDoc = o;
      if (this.version === 1) {
        this.extract(o);
      } else {
    ...
    docTranslator(parent, node, first) {
      ...
      if (doc.length > 0 && currentDoc.length > 0) {
        const newNode = {
          stmt: STMT_STATE,
          id: (0,_chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_4__.generateId)(),
          type: "divider",
    ...
    addState(id, type = DEFAULT_STATE_TYPE, doc = void 0, descr = void 0, note = void 0, classes = void 0, styles = void 0, textStyles = void 0) {
      ...
      if (!this.currentDocument.states.has(trimmedId)) {
        _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.log.info("Adding state ", trimmedId, descr);
      ...
      if (descr) {
        _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.log.info("Setting state description", trimmedId, descr);
      ...
      if (note) {
        ...
        doc2.note = note;
        doc2.note.text = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__.common_default.sanitizeText(doc2.note.text, (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)());
      }
      if (classes) {
        _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.log.info("Setting state classes", trimmedId, classes);
      ...
      if (styles) {
        _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.log.info("Setting state styles", trimmedId, styles);
    ...
    logDocuments() {
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.log.info("Documents = ", this.documents);
    }
    getRelations() {
    ...
    addLink(stateId, url, tooltip) {
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.log.warn("Adding link", stateId, url, tooltip);
    }
    /**
    ...
    addRelationObjs(item1, item2, relationTitle = "") {
      ...
      this.currentDocument.relations.push({
        id1,
        id2,
        relationTitle: _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__.common_default.sanitizeText(relationTitle, (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)())
      });
    }
    /**
    ...
    addRelation(item1, item2, title) {
      if (typeof item1 === "object" && typeof item2 === "object") {
        ...
        this.currentDocument.relations.push({
          id1,
          id2,
          relationTitle: title ? _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__.common_default.sanitizeText(title, (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)()) : void 0
        });
      }
    }
    addDescription(id, descr) {
      ...
      theState?.descriptions?.push(_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__.common_default.sanitizeText(_descr, (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)()));
    }
    cleanupLabel(label) {
    ...
    getConfig() {
      return (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)().state;
    }
  };
  return StateDB;
})();
...
var getStyles = /* @__PURE__ */(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__.__name)(options => `
...
/* harmony export */ });
/* harmony import */ var _chunk_DI55MBZ5_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chunk-DI55MBZ5.mjs */ 53102);
/* harmony import */ var _chunk_55IACEB6_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chunk-55IACEB6.mjs */ 5675);
/* harmony import */ var _chunk_QN33PNHL_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chunk-QN33PNHL.mjs */ 8086);
/* harmony import */ var _chunk_N4CR4FBY_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chunk-N4CR4FBY.mjs */ 72271);
/* harmony import */ var _chunk_QXUST7PY_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./chunk-QXUST7PY.mjs */ 98954);
/* harmony import */ var _chunk_HN2XXSSU_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./chunk-HN2XXSSU.mjs */ 36384);
/* harmony import */ var _chunk_JZLCHNYA_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./chunk-JZLCHNYA.mjs */ 87452);
/* harmony import */ var _chunk_CVBHYZKI_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./chunk-CVBHYZKI.mjs */ 32239);
/* harmony import */ var _chunk_ATLVNIR6_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./chunk-ATLVNIR6.mjs */ 19753);
/* harmony import */ var _chunk_JA3XYJ7Z_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./chunk-JA3XYJ7Z.mjs */ 59355);
/* harmony import */ var _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./chunk-S3R3BYOJ.mjs */ 52052);
/* harmony import */ var _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./chunk-ABZYJK2D.mjs */ 79006);
/* harmony import */ var _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./chunk-AGHRB4JF.mjs */ 32303);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! d3 */ 40622);
/* harmony import */ var dagre_d3_es_src_dagre_index_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! dagre-d3-es/src/dagre/index.js */ 85297);
/* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! dagre-d3-es/src/graphlib/index.js */ 61823);
...
var drawDescrState = /* @__PURE__ */(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_12__.__name)((g, stateDef) => {
  ...
  const description = g.append("text").attr("x", (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().state.padding).attr("y", titleHeight + (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().state.padding * 0.4 + (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().state.dividerMargin + (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().state.textHeight).attr("class", "state-description");
  let isFirst = true;
  let isSecond = true;
...
var addTitleAndBox = /* @__PURE__ */(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_12__.__name)((g, stateDef, altBkg) => {
  ...
  g.insert("rect", ":first-child").attr("x", startX).attr("y", lineY).attr("class", altBkg ? "alt-composit" : "composit").attr("width", width).attr("height", graphBox.height + (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().state.textHeight + (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().state.titleShift + 1).attr("rx", "0");
  title.attr("x", startX + pad);
  if (titleWidth <= orgWidth) {
    title.attr("x", orgX + (width - dblPad) / 2 - titleWidth / 2 + pad);
  }
  g.insert("rect", ":first-child").attr("x", startX).attr("y", (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().state.titleShift - (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().state.textHeight - (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().state.padding).attr("width", width).attr("height", (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().state.textHeight * 3).attr("rx", (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().state.radius);
  g.insert("rect", ":first-child").attr("x", startX).attr("y", (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().state.titleShift - (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().state.textHeight - (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().state.padding).attr("width", width).attr("height", graphBox.height + 3 + 2 * (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().state.textHeight).attr("rx", (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().state.radius);
  return g;
}, "addTitleAndBox");
var drawEndState = /* @__PURE__ */(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_12__.__name)(g => {
  g.append("circle").attr("class", "end-state-outer").attr("r", (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().state.sizeUnit + (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().state.miniPadding).attr("cx", (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().state.padding + (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().state.sizeUnit + (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().state.miniPadding).attr("cy", (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().state.padding + (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().state.sizeUnit + (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().state.miniPadding);
...
var drawEdge = /* @__PURE__ */(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_12__.__name)(function (elem, path, relation) {
  ...
  svgPath.attr("marker-end", "url(" + url + "#" + getRelationType(_chunk_DI55MBZ5_mjs__WEBPACK_IMPORTED_MODULE_0__.StateDB.relationType.DEPENDENCY) + "End)");
  if (relation.title !== void 0) {
    const label = elem.append("g").attr("class", "stateLabel");
    const {
      x,
      y
    } = _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_10__.utils_default.calcLabelPosition(path.points);
...
var setConf = /* @__PURE__ */(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_12__.__name)(function () {}, "setConf");

(self["webpackChunkdemo"] = self["webpackChunkdemo"] || []).push([[4135],{
...
/* harmony import */ var _chunk_VDROSRA5_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chunk-VDROSRA5.mjs */ 33757);
/* harmony import */ var _chunk_HPOVUXKZ_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chunk-HPOVUXKZ.mjs */ 74620);
/* harmony import */ var _chunk_BRE4QBWZ_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./chunk-BRE4QBWZ.mjs */ 81190);
/* harmony import */ var _chunk_AEN23PCK_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./chunk-AEN23PCK.mjs */ 82226);
/* harmony import */ var _chunk_NUTPFWZB_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./chunk-NUTPFWZB.mjs */ 43965);
/* harmony import */ var _chunk_DS2CGKN3_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./chunk-DS2CGKN3.mjs */ 86306);
/* harmony import */ var _chunk_YL523NDC_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./chunk-YL523NDC.mjs */ 26305);
/* harmony import */ var _chunk_7N6UNFX7_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./chunk-7N6UNFX7.mjs */ 76572);
/* harmony import */ var _chunk_F7MYA6JM_mjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./chunk-F7MYA6JM.mjs */ 37014);
/* harmony import */ var _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./chunk-BMRFU3JQ.mjs */ 20263);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! d3 */ 40622);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! khroma */ 61187);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! khroma */ 85404);
...
var FlowDB = class {
  ...
  constructor() {
    ...
    this.config = (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)();
    ...
    this.funs = [];
    this.setAccTitle = _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.setAccTitle;
    this.setAccDescription = _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.setAccDescription;
    this.setDiagramTitle = _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.setDiagramTitle;
    this.getAccTitle = _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.getAccTitle;
    this.getAccDescription = _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.getAccDescription;
    this.getDiagramTitle = _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.getDiagramTitle;
  ...
  static #_ = (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(this, "FlowDB");
  sanitizeText(txt) {
    return _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.common_default.sanitizeText(txt, this.config);
  }
  /**
  ...
  addVertex(id, textObj, type, style, classes, dir, props = {}, metadata) {
    ...
    if (metadata !== void 0) {
      ...
      doc = (0,_chunk_VDROSRA5_mjs__WEBPACK_IMPORTED_MODULE_2__.load)(yamlData, {
        schema: _chunk_VDROSRA5_mjs__WEBPACK_IMPORTED_MODULE_2__.JSON_SCHEMA
      });
    }
    ...
    if (doc !== void 0) {
      if (doc.shape) {
        ...
        } else if (!(0,_chunk_DS2CGKN3_mjs__WEBPACK_IMPORTED_MODULE_7__.isValidShape)(doc.shape)) {
  ...
  addSingleLink(_start, _end, type, id) {
    ...
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.log.info("abc78 Got edge...", edge);
    ...
    if (id && !this.edges.some(e => e.id === id)) {
      ...
      if (existingLinks.length === 0) {
        edge.id = (0,_chunk_F7MYA6JM_mjs__WEBPACK_IMPORTED_MODULE_10__.getEdgeId)(edge.start, edge.end, {
          counter: 0,
          prefix: "L"
        });
      } else {
    ...
    if (this.edges.length < (this.config.maxEdges ?? 500)) {
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.log.info("Pushing edge...");
...
You have to call mermaid.initialize.`);
  ...
  addLink(_start, _end, linkData) {
    ...
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.log.info("addLink", _start, _end, id);
  ...
  setClickFun(id, functionName, functionArgs) {
    ...
    if ((0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().securityLevel !== "loose") {
      return;
    }
      ...
      this.funs.push(() => {
        ...
        if (elem !== null) {
          elem.addEventListener("click", () => {
            _chunk_F7MYA6JM_mjs__WEBPACK_IMPORTED_MODULE_10__.utils_default.runFunc(functionName, ...argList);
          }, false);
        }
      });
    }
  ...
  setLink(ids, linkStr, target) {
    ids.split(",").forEach(id => {
      const vertex = this.vertices.get(id);
      if (vertex !== void 0) {
        vertex.link = _chunk_F7MYA6JM_mjs__WEBPACK_IMPORTED_MODULE_10__.utils_default.formatUrl(linkStr, this.config);
  ...
  setupToolTips(element) {
    let tooltipElem = (0,d3__WEBPACK_IMPORTED_MODULE_12__.select)(".mermaidTooltip");
    if ((tooltipElem._groups || tooltipElem)[0][0] === null) {
      tooltipElem = (0,d3__WEBPACK_IMPORTED_MODULE_12__.select)("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0);
    }
    const svg = (0,d3__WEBPACK_IMPORTED_MODULE_12__.select)(element).select("svg");
    const nodes = svg.selectAll("g.node");
    nodes.on("mouseover", e => {
      const el = (0,d3__WEBPACK_IMPORTED_MODULE_12__.select)(e.currentTarget);
  ...
  clear(ver = "gen-2") {
    ...
    this.version = ver;
    this.config = (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)();
    (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.clear)();
  }
  setGen(ver) {
  ...
  addSubGraph(_id, list, _title) {
    ...
    const uniq = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(a => {
      const prims = {
        boolean: {},
        number: {},
        string: {}
    ...
    let dir = result.dir;
    const flowchartConfig = (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().flowchart ?? {};
    dir = dir ?? (flowchartConfig.inheritDir ? this.getDirection() ?? (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)().direction ?? void 0 : void 0);
    ...
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.log.info("Adding", subGraph.id, subGraph.nodes, subGraph.dir);
  ...
  getData() {
    const config = (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)();
    const nodes = [];
    const edges = [];
    ...
    e.forEach((rawEdge, index) => {
      ...
      const edge = {
        id: (0,_chunk_F7MYA6JM_mjs__WEBPACK_IMPORTED_MODULE_10__.getEdgeId)(rawEdge.start, rawEdge.end, {
          counter: index,
          prefix: "L"
        }, rawEdge.id),
  ...
  defaultConfig() {
    return _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.defaultConfig2.flowchart;
  }
};

// src/diagrams/flowchart/flowRenderer-v3-unified.ts

var getClasses = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(function (text, diagramObj) {
  return diagramObj.db.getClasses();
}, "getClasses");
var draw = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(/*#__PURE__*/function () {
  var _ref = (0,_Users_ba5ik7_Documents_GIT_tmdjr_ngx_editor_js2_blocks_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (text, id, _version, diag) {
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.log.info("REF0:");
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.log.info("Drawing state diagram (v2)", id);
    const {
      securityLevel,
      flowchart: conf,
      layout
    } = (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.getConfig2)();
    let sandboxElement;
    if (securityLevel === "sandbox") {
      sandboxElement = (0,d3__WEBPACK_IMPORTED_MODULE_12__.select)("#i" + id);
    }
    const doc = securityLevel === "sandbox" ? sandboxElement.nodes()[0].contentDocument : document;
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.log.debug("Before getData: ");
    const data4Layout = diag.db.getData();
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.log.debug("Data: ", data4Layout);
    const svg = (0,_chunk_HPOVUXKZ_mjs__WEBPACK_IMPORTED_MODULE_3__.getDiagramElement)(id, securityLevel);
    const direction = diag.db.getDirection();
    data4Layout.type = diag.type;
    data4Layout.layoutAlgorithm = (0,_chunk_BRE4QBWZ_mjs__WEBPACK_IMPORTED_MODULE_4__.getRegisteredLayoutAlgorithm)(layout);
    if (data4Layout.layoutAlgorithm === "dagre" && layout === "elk") {
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.log.warn("flowchart-elk was moved to an external package in Mermaid v11. Please refer [release notes](https://github.com/mermaid-js/mermaid/releases/tag/v11.0.0) for more details. This diagram will be rendered using `dagre` layout as a fallback.");
    }
    ...
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.log.debug("REF1:", data4Layout);
    yield (0,_chunk_BRE4QBWZ_mjs__WEBPACK_IMPORTED_MODULE_4__.render)(data4Layout, svg);
    const padding = data4Layout.config.flowchart?.diagramPadding ?? 8;
    _chunk_F7MYA6JM_mjs__WEBPACK_IMPORTED_MODULE_10__.utils_default.insertTitle(svg, "flowchartTitleText", conf?.titleTopMargin || 0, diag.db.getDiagramTitle());
    (0,_chunk_HPOVUXKZ_mjs__WEBPACK_IMPORTED_MODULE_3__.setupViewPortForSVG)(svg, padding, "flowchart", conf?.useMaxWidth || false);
    for (const vertex of data4Layout.nodes) {
      const node = (0,d3__WEBPACK_IMPORTED_MODULE_12__.select)(`#${id} [id="${vertex.id}"]`);
      if (!node || !vertex.link) {
        continue;
      }
...
var parser = function () {
  var o = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(function (k, v, o2, l) {
  ...
  var parser2 = {
    trace: /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(function trace() {}, "trace"),
    yy: {},
    symbols_: {
      "error": 2,
      "start": 3,
    ...
    performAction: /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
      var $0 = $$.length - 1;
      switch (yystate) {
        case 2:
          this.$ = [];
    ...
    defaultActions: {},
    parseError: /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(function parseError(str, hash) {
      if (hash.recoverable) {
        this.trace(str);
      } else {
    ...
    parse: /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(function parse(input) {
      var self = this,
        stack = [0],
        tstack = [],
        vstack = [null],
      ...
      (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(popStack, "popStack");
      function lex() {
        var token;
      ...
      (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(lex, "lex");
      var symbol,
        preErrorSymbol,
        state,
        action,
  ...
  var lexer = /* @__PURE__ */function () {
    var lexer2 = {
      ...
      setInput: /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(function (input, yy) {
        this.yy = yy || this.yy || {};
        this._input = input;
      ...
      input: /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(function () {
      ...
      unput: /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(function (ch) {
        var len = ch.length;
        var lines = ch.split(/(?:\r\n?|\n)/g);
      ...
      more: /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(function () {
        this._more = true;
        return this;
      }, "more"),
      // When called from action, signals the lexer that this rule fails to match the input, so the next matching rule (regex) should be tested instead.
      reject: /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(function () {
      ...
      less: /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(function (n) {
        this.unput(this.match.slice(n));
      }, "less"),
      // displays already matched input, i.e. for error messages
      pastInput: /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(function () {
        var past = this.matched.substr(0, this.matched.length - this.match.length);
        return (past.length > 20 ? "..." : "") + past.substr(-20).replace(/\n/g, "");
      }, "pastInput"),
      // displays upcoming input, i.e. for error messages
      upcomingInput: /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(function () {
        var next = this.match;
        if (next.length < 20) {
      ...
      showPosition: /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(function () {
        var pre = this.pastInput();
        var c = new Array(pre.length + 1).join("-");
        return pre + this.upcomingInput() + "\n" + c + "^";
      }, "showPosition"),
      // test the lexed token: return FALSE when not a match, otherwise return token
      test_match: /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(function (match, indexed_rule) {
      ...
      next: /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(function () {
        if (this.done) {
          return this.EOF;
        }
        if (!this._input) {
      ...
      lex: /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(function lex() {
        var r = this.next();
        if (r) {
          return r;
        } else {
      ...
      begin: /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(function begin(condition) {
        this.conditionStack.push(condition);
      }, "begin"),
      // pop the previously active lexer condition state off the condition stack
      popState: /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(function popState() {
      ...
      _currentRules: /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(function _currentRules() {
      ...
      topState: /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(function topState(n) {
      ...
      pushState: /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(function pushState(condition) {
        this.begin(condition);
      }, "pushState"),
      // return the number of states currently on the stack
      stateStackSize: /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(function stateStackSize() {
        return this.conditionStack.length;
      }, "stateStackSize"),
      options: {},
      performAction: /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(function anonymous(yy, yy_, $avoiding_name_collisions, YY_START) {
  ...
  (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(Parser, "Parser");
...
var fade = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)((color, opacity) => {
...
var getStyles = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(options => `.label {
...
var diagram = {
  ...
  init: /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.__name)(cnf => {
    if (!cnf.flowchart) {
      cnf.flowchart = {};
    }
    if (cnf.layout) {
      (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_11__.setConfig2)({
        layout: cnf.layout
      });
    }

(self["webpackChunkdemo"] = self["webpackChunkdemo"] || []).push([[1523],{
...
/* harmony import */ var _chunk_AEN23PCK_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chunk-AEN23PCK.mjs */ 82226);
/* harmony import */ var _chunk_NUTPFWZB_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chunk-NUTPFWZB.mjs */ 43965);
/* harmony import */ var _chunk_DS2CGKN3_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chunk-DS2CGKN3.mjs */ 86306);
/* harmony import */ var _chunk_YL523NDC_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./chunk-YL523NDC.mjs */ 26305);
/* harmony import */ var _chunk_7N6UNFX7_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./chunk-7N6UNFX7.mjs */ 76572);
/* harmony import */ var _chunk_F7MYA6JM_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./chunk-F7MYA6JM.mjs */ 37014);
/* harmony import */ var _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./chunk-BMRFU3JQ.mjs */ 20263);
/* harmony import */ var dagre_d3_es_src_dagre_index_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! dagre-d3-es/src/dagre/index.js */ 85297);
/* harmony import */ var dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! dagre-d3-es/src/graphlib/json.js */ 46865);
/* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! dagre-d3-es/src/graphlib/index.js */ 61823);
...
var clear4 = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)(() => {
  descendants.clear();
  parents.clear();
  clusterDb.clear();
}, "clear");
var isDescendant = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)((id, ancestorId) => {
  const ancestorDescendants = descendants.get(ancestorId) || [];
  _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.trace("In isDescendant", ancestorId, " ", id, " = ", ancestorDescendants.includes(id));
  return ancestorDescendants.includes(id);
}, "isDescendant");
var edgeInCluster = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)((edge, clusterId) => {
  const clusterDescendants = descendants.get(clusterId) || [];
  _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("Descendants of ", clusterId, " is ", clusterDescendants);
  _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("Edge is ", edge);
  if (edge.v === clusterId || edge.w === clusterId) {
    return false;
  }
  if (!clusterDescendants) {
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.debug("Tilt, ", clusterId, ",not in descendants");
    return false;
  }
  return clusterDescendants.includes(edge.v) || isDescendant(edge.v, clusterId) || isDescendant(edge.w, clusterId) || clusterDescendants.includes(edge.w);
}, "edgeInCluster");
var copy = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)((clusterId, graph, newGraph, rootId) => {
  _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.warn("Copying children of ", clusterId, "root", rootId, "data", graph.node(clusterId), rootId);
  const nodes = graph.children(clusterId) || [];
  if (clusterId !== rootId) {
    nodes.push(clusterId);
  }
  _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.warn("Copying (nodes) clusterId", clusterId, "nodes", nodes);
  nodes.forEach(node => {
    if (graph.children(node).length > 0) {
      copy(node, graph, newGraph, rootId);
    } else {
      const data = graph.node(node);
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("cp ", node, " to ", rootId, " with parent ", clusterId);
      newGraph.setNode(node, data);
      if (rootId !== graph.parent(node)) {
        _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.warn("Setting parent", node, graph.parent(node));
        newGraph.setParent(node, graph.parent(node));
      }
      if (clusterId !== rootId && node !== clusterId) {
        _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.debug("Setting parent", node, clusterId);
        newGraph.setParent(node, clusterId);
      } else {
        _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("In copy ", clusterId, "root", rootId, "data", graph.node(clusterId), rootId);
        _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.debug("Not Setting parent for node=", node, "cluster!==rootId", clusterId !== rootId, "node!==clusterId", node !== clusterId);
      }
      const edges = graph.edges(node);
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.debug("Copying Edges", edges);
      edges.forEach(edge => {
        _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("Edge", edge);
        const data2 = graph.edge(edge.v, edge.w, edge.name);
        _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("Edge data", data2, rootId);
        try {
          if (edgeInCluster(edge, rootId)) {
            _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("Copying as ", edge.v, edge.w, data2, edge.name);
            newGraph.setEdge(edge.v, edge.w, data2, edge.name);
            _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("newGraph edges ", newGraph.edges(), newGraph.edge(newGraph.edges()[0]));
          } else {
            _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("Skipping copy of edge ", edge.v, "-->", edge.w, " rootId: ", rootId, " clusterId:", clusterId);
          }
        } catch (e) {
          _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.error(e);
        }
      });
    }
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.debug("Removing node", node);
    graph.removeNode(node);
  });
}, "copy");
var extractDescendants = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)((id, graph) => {
...
var findCommonEdges = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)((graph, id1, id2) => {
...
var findNonClusterChild = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)((id, graph, clusterId) => {
  const children = graph.children(id);
  _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.trace("Searching children of id ", id, children);
...
var getAnchorId = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)(id => {
  if (!clusterDb.has(id)) {
    return id;
  }
...
var adjustClustersAndEdges = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)((graph, depth) => {
  if (!graph || depth > 10) {
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.debug("Opting out, no graph ");
    return;
  } else {
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.debug("Opting in, graph ");
  }
  graph.nodes().forEach(function (id) {
    const children = graph.children(id);
    if (children.length > 0) {
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.warn("Cluster identified", id, " Replacement id in edges: ", findNonClusterChild(id, graph, id));
  ...
  graph.nodes().forEach(function (id) {
    ...
    if (children.length > 0) {
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.debug("Cluster identified", id, descendants);
      edges.forEach(edge => {
        const d1 = isDescendant(edge.v, id);
        const d2 = isDescendant(edge.w, id);
        if (d1 ^ d2) {
          _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.warn("Edge: ", edge, " leaves cluster ", id);
          _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.warn("Descendants of XXX ", id, ": ", descendants.get(id));
          clusterDb.get(id).externalConnections = true;
        }
      });
    } else {
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.debug("Not a cluster ", id, descendants);
    }
  });
  ...
  graph.edges().forEach(function (e) {
    ...
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.warn("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(e));
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.warn("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(graph.edge(e)));
    let v = e.v;
    let w = e.w;
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.warn("Fix XXX", clusterDb, "ids:", e.v, e.w, "Translating: ", clusterDb.get(e.v), " --- ", clusterDb.get(e.w));
    if (clusterDb.get(e.v) || clusterDb.get(e.w)) {
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.warn("Fixing and trying - removing XXX", e.v, e.w, e.name);
      v = getAnchorId(e.v);
      w = getAnchorId(e.w);
      ...
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.warn("Fix Replacing with XXX", v, w, e.name);
      graph.setEdge(v, w, edge, e.name);
    }
  });
  _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.warn("Adjusted Graph", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_9__.write(graph));
  extractor(graph, 0);
  _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.trace(clusterDb);
}, "adjustClustersAndEdges");
var extractor = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)((graph, depth) => {
  _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.warn("extractor - ", depth, dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_9__.write(graph), graph.children("D"));
  if (depth > 10) {
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.error("Bailing out");
    return;
  }
  ...
  if (!hasChildren) {
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.debug("Done, no node has children", graph.nodes());
    return;
  }
  _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.debug("Nodes = ", nodes, depth);
  for (const node of nodes) {
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.debug("Extracting node", node, clusterDb, clusterDb.has(node) && !clusterDb.get(node).externalConnections, !graph.parent(node), graph.node(node), graph.children("D"), " Depth ", depth);
    if (!clusterDb.has(node)) {
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.debug("Not a cluster", node, depth);
    } else if (!clusterDb.get(node).externalConnections && graph.children(node) && graph.children(node).length > 0) {
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.warn("Cluster without external connections, without a parent and with children", node, depth);
      const graphSettings = graph.graph();
      let dir = graphSettings.rankdir === "TB" ? "LR" : "TB";
      if (clusterDb.get(node)?.clusterData?.dir) {
        dir = clusterDb.get(node).clusterData.dir;
        _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.warn("Fixing dir", clusterDb.get(node).clusterData.dir, dir);
      }
      ...
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.warn("Old graph before copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_9__.write(graph));
      ...
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.warn("New graph after copy node: (", node, ")", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_9__.write(clusterGraph));
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.debug("Old graph after copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_9__.write(graph));
    } else {
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.warn("Cluster ** ", node, " **not meeting the criteria !externalConnections:", !clusterDb.get(node).externalConnections, " no parent: ", !graph.parent(node), " children ", graph.children(node) && graph.children(node).length > 0, graph.children("D"), depth);
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.debug(clusterDb);
    }
  }
  nodes = graph.nodes();
  _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.warn("New list of nodes", nodes);
  for (const node of nodes) {
    const data = graph.node(node);
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.warn(" Now next level", node, data);
    if (data?.clusterNode) {
      extractor(data.graph, depth + 1);
    }
  }
}, "extractor");
var sorter = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)((graph, nodes) => {
  if (nodes.length === 0) {
    return [];
  }
...
var sortNodesByHierarchy = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)(graph => sorter(graph, graph.children()), "sortNodesByHierarchy");

// src/rendering-util/layout-algorithms/dagre/index.js
var recursiveRender = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)(/*#__PURE__*/function () {
  var _ref = (0,_Users_ba5ik7_Documents_GIT_tmdjr_ngx_editor_js2_blocks_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (_elem, graph, diagramType, id, parentCluster, siteConfig) {
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.warn("Graph in recursive render:XAX", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_9__.write(graph), parentCluster);
    const dir = graph.graph().rankdir;
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.trace("Dir in recursive render - dir:", dir);
    const elem = _elem.insert("g").attr("class", "root");
    if (!graph.nodes()) {
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("No nodes found for", graph);
    } else {
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("Recursive render XXX", graph.nodes());
    }
    if (graph.edges().length > 0) {
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("Recursive edges", graph.edge(graph.edges()[0]));
    }
    ...
    yield Promise.all(graph.nodes().map(/*#__PURE__*/function () {
      var _ref2 = (0,_Users_ba5ik7_Documents_GIT_tmdjr_ngx_editor_js2_blocks_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (v) {
        ...
        if (parentCluster !== void 0) {
          ...
          _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.trace("Setting data for parent cluster XXX\n Node.id = ", v, "\n data=", data.height, "\nParent cluster", parentCluster.height);
          graph.setNode(parentCluster.id, data);
          if (!graph.parent(v)) {
            _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.trace("Setting parent", v, parentCluster.id);
            graph.setParent(v, parentCluster.id, data);
          }
        }
        _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("(Insert) Node XXX" + v + ": " + JSON.stringify(graph.node(v)));
        if (node?.clusterNode) {
          _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("Cluster identified XBX", v, node.width, graph.node(v));
          const {
            ranksep,
            nodesep
          } = graph.graph();
          ...
          const newEl = o.elem;
          (0,_chunk_DS2CGKN3_mjs__WEBPACK_IMPORTED_MODULE_3__.updateNodeBounds)(node, newEl);
          node.diff = o.diff || 0;
          _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("New compound node after recursive render XAX", v, "width",
          // node,
          node.width, "height", node.height
          // node.x,
          // node.y
          );
          (0,_chunk_DS2CGKN3_mjs__WEBPACK_IMPORTED_MODULE_3__.setNodeElem)(newEl, node);
        } else {
          if (graph.children(v).length > 0) {
            _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.trace("Cluster - the non recursive path XBX", v, node.id, node, node.width, "Graph:", graph);
            _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.trace(findNonClusterChild(node.id, graph));
            clusterDb.set(node.id, {
              id: findNonClusterChild(node.id, graph),
              node
            });
          } else {
            _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.trace("Node - the non recursive path XAX", v, nodes, graph.node(v), dir);
            yield (0,_chunk_DS2CGKN3_mjs__WEBPACK_IMPORTED_MODULE_3__.insertNode)(nodes, graph.node(v), {
              config: siteConfig,
              dir
            });
          }
    ...
    const processEdges = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)(/*#__PURE__*/(0,_Users_ba5ik7_Documents_GIT_tmdjr_ngx_editor_js2_blocks_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const edgePromises = graph.edges().map(/*#__PURE__*/function () {
        var _ref4 = (0,_Users_ba5ik7_Documents_GIT_tmdjr_ngx_editor_js2_blocks_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (e) {
          ...
          _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(e));
          _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("Edge " + e.v + " -> " + e.w + ": ", e, " ", JSON.stringify(graph.edge(e)));
          _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("Fix", clusterDb, "ids:", e.v, e.w, "Translating: ", clusterDb.get(e.v), clusterDb.get(e.w));
          yield (0,_chunk_AEN23PCK_mjs__WEBPACK_IMPORTED_MODULE_1__.insertEdgeLabel)(edgeLabels, edge);
        });
        return function (_x8) {
    ...
    yield processEdges();
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("Graph before layout:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_9__.write(graph)));
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("############################################# XXX");
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("###                Layout                 ### XXX");
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("############################################# XXX");
    (0,dagre_d3_es_src_dagre_index_js__WEBPACK_IMPORTED_MODULE_8__.layout)(graph);
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("Graph after layout:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_9__.write(graph)));
    let diff = 0;
    let {
      subGraphTitleTotalMargin
    } = (0,_chunk_YL523NDC_mjs__WEBPACK_IMPORTED_MODULE_4__.getSubGraphTitleMargins)(siteConfig);
    yield Promise.all(sortNodesByHierarchy(graph).map(/*#__PURE__*/function () {
      var _ref5 = (0,_Users_ba5ik7_Documents_GIT_tmdjr_ngx_editor_js2_blocks_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (v) {
        const node = graph.node(v);
        _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("Position XBX => " + v + ": (" + node.x, "," + node.y, ") width: ", node.width, " height: ", node.height);
        if (node?.clusterNode) {
          node.y += subGraphTitleTotalMargin;
          _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("A tainted cluster node XBX1", v, node.id, node.width, node.height, node.x, node.y, graph.parent(v));
          clusterDb.get(node.id).node = node;
          (0,_chunk_DS2CGKN3_mjs__WEBPACK_IMPORTED_MODULE_3__.positionNode)(node);
        } else {
          if (graph.children(v).length > 0) {
            _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("A pure cluster node XBX1", v, node.id, node.x, node.y, node.width, node.height, graph.parent(v));
            node.height += subGraphTitleTotalMargin;
            graph.node(node.parentId);
            const halfPadding = node?.padding / 2 || 0;
            const labelHeight = node?.labelBBox?.height || 0;
            const offsetY = labelHeight - halfPadding || 0;
            _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.debug("OffsetY", offsetY, "labelHeight", labelHeight, "halfPadding", halfPadding);
            yield (0,_chunk_DS2CGKN3_mjs__WEBPACK_IMPORTED_MODULE_3__.insertCluster)(clusters, node);
            clusterDb.get(node.id).node = node;
          } else {
            const parent = graph.node(node.parentId);
            node.y += subGraphTitleTotalMargin / 2;
            _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("A regular node XBX1 - using the padding", node.id, "parent", node.parentId, node.width, node.height, node.x, node.y, "offsetY", node.offsetY, "parent", parent, parent?.offsetY, node);
            (0,_chunk_DS2CGKN3_mjs__WEBPACK_IMPORTED_MODULE_3__.positionNode)(node);
          }
        }
      });
    ...
    graph.edges().forEach(function (e) {
      const edge = graph.edge(e);
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(edge), edge);
      edge.points.forEach(point => point.y += subGraphTitleTotalMargin / 2);
      const startNode = graph.node(e.v);
      var endNode = graph.node(e.w);
      const paths = (0,_chunk_AEN23PCK_mjs__WEBPACK_IMPORTED_MODULE_1__.insertEdge)(edgePaths, edge, clusterDb, diagramType, startNode, endNode, id);
      (0,_chunk_AEN23PCK_mjs__WEBPACK_IMPORTED_MODULE_1__.positionEdgeLabel)(edge, paths);
    });
    graph.nodes().forEach(function (v) {
      const n = graph.node(v);
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.info(v, n.type, n.diff);
      if (n.isGroup) {
        diff = n.diff;
      }
    });
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.warn("Returning from recursive render XAX", elem, diff);
    return {
      elem,
      diff
    };
...
var render = /* @__PURE__ */(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)(/*#__PURE__*/function () {
  var _ref6 = (0,_Users_ba5ik7_Documents_GIT_tmdjr_ngx_editor_js2_blocks_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (data4Layout, svg) {
    ...
    (0,_chunk_AEN23PCK_mjs__WEBPACK_IMPORTED_MODULE_1__.markers_default)(element, data4Layout.markers, data4Layout.type, data4Layout.diagramId);
    (0,_chunk_DS2CGKN3_mjs__WEBPACK_IMPORTED_MODULE_3__.clear2)();
    (0,_chunk_AEN23PCK_mjs__WEBPACK_IMPORTED_MODULE_1__.clear)();
    (0,_chunk_DS2CGKN3_mjs__WEBPACK_IMPORTED_MODULE_3__.clear)();
    clear4();
    ...
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.debug("Edges:", data4Layout.edges);
    ...
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.warn("Graph at first:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_9__.write(graph)));
    adjustClustersAndEdges(graph);
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.log.warn("Graph after XAX:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_9__.write(graph)));
    const siteConfig = (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_7__.getConfig2)();

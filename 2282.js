...
/* harmony export */ });
/* harmony import */ var _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chunk-S3R3BYOJ.mjs */ 52052);
/* harmony import */ var _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chunk-ABZYJK2D.mjs */ 79006);
/* harmony import */ var _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chunk-AGHRB4JF.mjs */ 32303);
/* harmony import */ var _braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @braintree/sanitize-url */ 73986);
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! dayjs */ 49645);
/* harmony import */ var dayjs_plugin_isoWeek_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! dayjs/plugin/isoWeek.js */ 64693);
/* harmony import */ var dayjs_plugin_customParseFormat_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! dayjs/plugin/customParseFormat.js */ 30001);
/* harmony import */ var dayjs_plugin_advancedFormat_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! dayjs/plugin/advancedFormat.js */ 37355);
/* harmony import */ var dayjs_plugin_duration_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! dayjs/plugin/duration.js */ 89630);
...
var draw = /* @__PURE__ */(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_2__.__name)(function (text, id, version, diagObj) {
  ...
  const timeScale = (0,d3__WEBPACK_IMPORTED_MODULE_9__.scaleTime)().domain([(0,d3__WEBPACK_IMPORTED_MODULE_9__.min)(taskArray, function (d) {
    return d.startTime;
  ...
  function makeGrid(theSidePad, theTopPad, w2, h2) {
    ...
    if (resultTickInterval !== null) {
      ...
      if (isNaN(every) || every <= 0) {
        _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_2__.log.warn(`Invalid tick interval value: "${resultTickInterval[1]}". Skipping custom tick interval.`);
      } else {
        ...
        if (estimatedTicks > MAX_TICK_COUNT) {
          _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_2__.log.warn(`The tick interval "${every}${interval}" would generate ${estimatedTicks} ticks, which exceeds the maximum allowed (${MAX_TICK_COUNT}). This may indicate an invalid date or time range. Skipping custom tick interval.`);
        } else {
          switch (interval) {
            case "millisecond":
